    ...
    <div className="min-h-screen bg-stone-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-5xl font-extrabold text-stone-800 tracking-tight font-serif-jp">
            選べる受講コース
          </h1>
          <p className="mt-4 max-w-xl mx-auto text-lg text-stone-600 font-medium">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-16">
          ...
          {/* Basic Course */}
          <div className="bg-white rounded-2xl shadow-sm border border-stone-200 hover:shadow-md transition-shadow overflow-hidden flex flex-col">
            <div className="p-8 flex-1">
              <h3 className="text-2xl font-bold text-stone-800">基本講座</h3>
              <p className="mt-4 text-stone-500 text-sm">費用を抑えて学習したい方、試験を受けて実力を試したい方へ。</p>
              <div className="mt-6 flex items-baseline">
                <span className="text-3xl md:text-4xl font-extrabold text-stone-800">59,800円</span>
                <span className="ml-2 text-stone-500">(税込)</span>
              </div>
              
              <ul className="mt-8 space-y-4 text-sm font-medium text-stone-600">
            ...
            <div className="p-8 bg-stone-50 border-t border-stone-100 mt-auto">
              <Button fullWidth variant="outline">基本講座に申し込む</Button>
            </div>
          </div>

          {/* Special Course */}
          <div className="bg-white rounded-2xl shadow-lg border-2 border-[#FF8C6B] relative overflow-hidden transform md:-translate-y-4 flex flex-col">
            <div className="absolute top-0 right-0 bg-[#FF8C6B] text-white text-xs font-bold px-4 py-1 uppercase tracking-wide rounded-bl-lg">
              人気No.1
            </div>
            <div className="p-8 flex-1">
              <h3 className="text-2xl font-bold text-stone-800">スペシャル講座</h3>
              <p className="mt-4 text-stone-500 text-sm">最短ルートで確実に資格取得。100%合格保証付き。</p>
              <div className="mt-6 flex items-baseline">
                <span className="text-3xl md:text-4xl font-extrabold text-[#FF8C6B]">79,800円</span>
                <span className="ml-2 text-stone-500">(税込)</span>
              </div>
              
              <ul className="mt-8 space-y-4 text-sm font-medium text-stone-700">
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" /> 完全攻略テキスト教材
                </li>
                <li className="flex items-center">
                ...
                <li className="flex items-center font-bold text-stone-900 bg-orange-50 p-2 rounded -mx-2">
            ...
            <div className="p-8 bg-stone-50 border-t border-stone-100 mt-auto">
              <Button fullWidth variant="orange" className="text-lg py-4 shadow-md hover:shadow-lg">スペシャル講座に申し込む</Button>
              <p className="text-center text-xs text-stone-400 mt-3">※ 分割払いも可能です</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto mb-20">
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 md:p-10 relative overflow-hidden shadow-sm">
            <div className="absolute top-0 left-0 w-2 h-full bg-amber-400"></div>
            <div className="flex flex-col md:flex-row items-center gap-6">
              <div className="bg-white p-4 rounded-full shadow-sm border border-amber-100 flex-shrink-0">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-bold text-stone-900 flex items-center justify-center font-serif-jp">
          ...
          <div className="space-y-6">
            <div className="bg-white border border-stone-200 rounded-xl p-6 shadow-sm">
              <h3 className="text-lg font-bold text-stone-800 mb-3 flex items-start">
                <span className="bg-stone-200 text-stone-600 text-xs px-2 py-1 rounded mr-3 mt-0.5">Q</span>
                万が一、試験に落ちてしまったらどうなりますか？
              </h3>
              <div className="pl-10 text-stone-600 text-sm leading-relaxed font-medium">
        ...
        <div className="mt-16 text-center text-stone-500 text-xs md:text-sm bg-stone-100 p-4 rounded-lg max-w-2xl mx-auto">
